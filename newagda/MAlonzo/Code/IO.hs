...
du_sequence_12 v0 v1
  = case coe v1 of
      ...
      MAlonzo.Code.Codata.Musical.Colist.Base.C__'8759'__30 v2 v3
        -> coe
             MAlonzo.Code.IO.Base.C_bind_36 (coe du_'9839''45'0_339 (coe v2))
             (coe du_'9839''45'1_521 (coe v0) (coe v3))
...
du_sequence'8242'_22 v0 v1
  = case coe v1 of
      ...
      MAlonzo.Code.Codata.Musical.Colist.Base.C__'8759'__30 v2 v3
        -> coe
             MAlonzo.Code.IO.Base.C_seq_44 (coe du_'9839''45'5_2655 (coe v2))
             (coe du_'9839''45'6_2835 (coe v0) (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
-- IO.Colist.mapM
d_mapM_28 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
...
d_sequence_38 ~v0 ~v1 v2 = du_sequence_38 v2
du_sequence_38 ::
  [MAlonzo.Code.IO.Base.T_IO_16] -> MAlonzo.Code.IO.Base.T_IO_16
du_sequence_38 v0
  = case coe v0 of
      ...
      (:) v1 v2
        -> coe
             MAlonzo.Code.IO.Base.du__'60''42''62'__58
             (coe
                MAlonzo.Code.IO.Base.du__'60''42''62'__58
                (coe
...
d_sequence'8242'_44 ::
  ...
  () ->
  [MAlonzo.Code.IO.Base.T_IO_16] -> MAlonzo.Code.IO.Base.T_IO_16
d_sequence'8242'_44 ~v0 ~v1 v2 = du_sequence'8242'_44 v2
du_sequence'8242'_44 ::
  [MAlonzo.Code.IO.Base.T_IO_16] -> MAlonzo.Code.IO.Base.T_IO_16
du_sequence'8242'_44 v0
  = case coe v0 of
      []
        -> coe
             MAlonzo.Code.IO.Base.C_return_26
      ...
      (:) v1 v2
        -> coe
             MAlonzo.Code.IO.Base.du__'62''62'__82 (coe v1)
             (coe du_sequence'8242'_44 (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
-- IO.List.mapM
d_mapM_50 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  ...
  (AgdaAny -> MAlonzo.Code.IO.Base.T_IO_16) ->
  [AgdaAny] -> MAlonzo.Code.IO.Base.T_IO_16
d_mapM_50 ~v0 ~v1 ~v2 ~v3 v4 v5 = du_mapM_50 v4 v5
du_mapM_50 ::
  (AgdaAny -> MAlonzo.Code.IO.Base.T_IO_16) ->
  [AgdaAny] -> MAlonzo.Code.IO.Base.T_IO_16
du_mapM_50 v0 v1
...
d_mapM'8242'_54 ::
  ...
  (AgdaAny -> MAlonzo.Code.IO.Base.T_IO_16) ->
  [AgdaAny] -> MAlonzo.Code.IO.Base.T_IO_16
d_mapM'8242'_54 ~v0 ~v1 ~v2 ~v3 v4 v5 = du_mapM'8242'_54 v4 v5
du_mapM'8242'_54 ::
  (AgdaAny -> MAlonzo.Code.IO.Base.T_IO_16) ->
  [AgdaAny] -> MAlonzo.Code.IO.Base.T_IO_16
du_mapM'8242'_54 v0 v1
  = coe
      du_sequence'8242'_44
      (coe MAlonzo.Code.Data.List.Base.du_map_22 (coe v0) (coe v1))
-- IO.Colist._.♯-0
...
d_'9839''45'0_339 ~v0 ~v1 v2 ~v3 = du_'9839''45'0_339 v2
du_'9839''45'0_339 ::
  MAlonzo.Code.IO.Base.T_IO_16 ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_16
du_'9839''45'0_339 v0
...
d_'9839''45'1_521 ::
  ...
  AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_16
d_'9839''45'1_521 v0 ~v1 ~v2 v3 v4 = du_'9839''45'1_521 v0 v3 v4
du_'9839''45'1_521 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.RTE.Infinity
    AgdaAny
  ...
  AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_16
du_'9839''45'1_521 v0 v1 v2
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
         MAlonzo.Code.IO.Base.C_bind_36
         (coe du_'9839''45'2_739 (coe v0) (coe v1))
         (coe du_'9839''45'3_1117 (coe v2)))
-- IO.Colist._._.♯-2
d_'9839''45'2_739 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  ...
  AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_16
d_'9839''45'2_739 v0 ~v1 ~v2 v3 ~v4 = du_'9839''45'2_739 v0 v3
du_'9839''45'2_739 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.RTE.Infinity
    AgdaAny
...
d_'9839''45'3_1117 ::
  ...
  MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
    AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_16
d_'9839''45'3_1117 ~v0 ~v1 ~v2 ~v3 v4 v5
  = du_'9839''45'3_1117 v4 v5
du_'9839''45'3_1117 ::
  AgdaAny ->
  MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
    AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_16
du_'9839''45'3_1117 v0 v1
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
         MAlonzo.Code.IO.Base.C_return_26
...
d_'9839''45'4_1451 ::
  ...
  MAlonzo.RTE.Infinity
    ...
    (MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
       AgdaAny AgdaAny)
d_'9839''45'4_1451 ~v0 ~v1 ~v2 ~v3 ~v4 v5 = du_'9839''45'4_1451 v5
du_'9839''45'4_1451 ::
  MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
    AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity
...
d_'9839''45'5_2655 ::
  ...
  MAlonzo.RTE.Infinity
    ...
    (MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
       AgdaAny MAlonzo.Code.IO.Base.T_IO_16) ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_16
d_'9839''45'5_2655 ~v0 ~v1 v2 ~v3 = du_'9839''45'5_2655 v2
du_'9839''45'5_2655 ::
  MAlonzo.Code.IO.Base.T_IO_16 ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_16
du_'9839''45'5_2655 v0
  = coe MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16 (coe v0)
-- IO.Colist._.♯-6
d_'9839''45'6_2835 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  ...
  MAlonzo.RTE.Infinity
    ...
    (MAlonzo.Code.Codata.Musical.Colist.Base.T_Colist_20
       AgdaAny MAlonzo.Code.IO.Base.T_IO_16) ->
  MAlonzo.RTE.Infinity AgdaAny MAlonzo.Code.IO.Base.T_IO_16
d_'9839''45'6_2835 v0 ~v1 ~v2 v3 = du_'9839''45'6_2835 v0 v3
du_'9839''45'6_2835 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.RTE.Infinity
    AgdaAny
