  ...
  = case coe v1 of
      ...
      C__'8759'__30 v2 v3
        -> coe
             ...
             (coe du_'9839''45'0_869 (coe v0) (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v3 of
      ...
      C__'8759'__30 v4 v5
        -> coe
             ...
             (coe du_'9839''45'1_1875 (coe v0) (coe v1) (coe v2) (coe v5))
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_fromList_50 v0 v1
  = case coe v1 of
      ...
      (:) v2 v3
        -> coe
             C__'8759'__30 (coe v2) (coe du_'9839''45'2_3139 (coe v0) (coe v3))
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v1 of
      ...
      MAlonzo.Code.Codata.Musical.Conat.Base.C_suc_14 v3
        -> coe
             ...
             (coe du_'9839''45'3_3857 (coe v0) (coe v3) (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
  ...
  = case coe v1 of
      ...
      C__'8759'__30 v3 v4
        -> coe
             ...
             (coe du_'9839''45'4_5647 (coe v0) (coe v4) (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
-- Codata.Musical.Colist.Base._⋎_
d__'8910'__88 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
...
du__'8910'__88 v0 v1 v2
  = case coe v1 of
      ...
      C__'8759'__30 v3 v4
        -> coe
             C__'8759'__30 (coe v3)
             (coe du_'9839''45'5_6583 (coe v0) (coe v4) (coe v2))
      _ -> MAlonzo.RTE.mazUnreachableError
        ...
        -> case coe v2 of
             MAlonzo.Code.Data.List.NonEmpty.Base.C__'8759'__36 v4 v5
               -> case coe v5 of
                    []
                      -> coe
                           C__'8759'__30 (coe v4) (coe du_'9839''45'6_7607 (coe v0) (coe v3))
                    (:) v6 v7
                      -> coe
                           C__'8759'__30 (coe v4)
                           (coe du_'9839''45'7_8169 (coe v0) (coe v6) (coe v7) (coe v3))
                    _ -> MAlonzo.RTE.mazUnreachableError
             _ -> MAlonzo.RTE.mazUnreachableError
      _ -> MAlonzo.RTE.mazUnreachableError
...
du_'91'_'93'_112 v0
  = coe C__'8759'__30 (coe v0) (coe du_'9839''45'8_9281)
...
d_'9839''45'0_869 v0 ~v1 ~v2 v3 = du_'9839''45'0_869 v0 v3
du_'9839''45'0_869 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny) ->
  MAlonzo.RTE.Infinity
    AgdaAny MAlonzo.Code.Codata.Musical.Conat.Base.T_Coℕ_8
du_'9839''45'0_869 v0 v1
  = coe
...
d_'9839''45'1_1875 ::
  ...
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'1_1875 v0 ~v1 v2 ~v3 v4 ~v5 v6
  = du_'9839''45'1_1875 v0 v2 v4 v6
du_'9839''45'1_1875 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  (AgdaAny -> AgdaAny) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'1_1875 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
...
d_'9839''45'2_3139 ::
  ...
  [AgdaAny] ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'2_3139 v0 ~v1 ~v2 v3 = du_'9839''45'2_3139 v0 v3
du_'9839''45'2_3139 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  [AgdaAny] ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'2_3139 v0 v1
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
...
d_'9839''45'3_3857 ::
  ...
  AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'3_3857 v0 ~v1 v2 v3 = du_'9839''45'3_3857 v0 v2 v3
du_'9839''45'3_3857 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.RTE.Infinity
    AgdaAny MAlonzo.Code.Codata.Musical.Conat.Base.T_Coℕ_8 ->
...
d_'9839''45'4_5647 ::
  ...
  T_Colist_20 AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'4_5647 v0 ~v1 ~v2 v3 v4 = du_'9839''45'4_5647 v0 v3 v4
du_'9839''45'4_5647 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny) ->
  T_Colist_20 AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'4_5647 v0 v1 v2
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
...
d_'9839''45'5_6583 ::
  ...
  T_Colist_20 AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'5_6583 v0 ~v1 ~v2 v3 v4 = du_'9839''45'5_6583 v0 v3 v4
du_'9839''45'5_6583 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny) ->
  T_Colist_20 AgdaAny AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'5_6583 v0 v1 v2
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
...
d_'9839''45'6_7607 ::
  ...
  MAlonzo.RTE.Infinity
    ...
    (T_Colist_20
       AgdaAny MAlonzo.Code.Data.List.NonEmpty.Base.T_List'8314'_24) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'6_7607 v0 ~v1 ~v2 v3 = du_'9839''45'6_7607 v0 v3
du_'9839''45'6_7607 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.RTE.Infinity
    AgdaAny
...
d_'9839''45'7_8169 ::
  ...
  MAlonzo.RTE.Infinity
    ...
    (T_Colist_20
       AgdaAny MAlonzo.Code.Data.List.NonEmpty.Base.T_List'8314'_24) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'7_8169 v0 ~v1 ~v2 v3 v4 v5
  = du_'9839''45'7_8169 v0 v3 v4 v5
du_'9839''45'7_8169 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  AgdaAny ->
  [AgdaAny] ->
  MAlonzo.RTE.Infinity
    ...
    (T_Colist_20
       AgdaAny MAlonzo.Code.Data.List.NonEmpty.Base.T_List'8314'_24) ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'7_8169 v0 v1 v2 v3
  = coe
      MAlonzo.Code.Agda.Builtin.Coinduction.C_'9839'__16
      (coe
         du_concat_98 (coe v0)
...
d_'9839''45'8_9281 ::
  ...
  AgdaAny ->
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
d_'9839''45'8_9281 ~v0 ~v1 ~v2 = du_'9839''45'8_9281
du_'9839''45'8_9281 ::
  MAlonzo.RTE.Infinity AgdaAny (T_Colist_20 AgdaAny AgdaAny)
du_'9839''45'8_9281
  = coe
