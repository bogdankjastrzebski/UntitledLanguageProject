...
d_isPreorder_126 v0
  = case coe v0 of
      C_IsTotalPreorder'46'constructor_7939 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_total_128 v0
  = case coe v0 of
      C_IsTotalPreorder'46'constructor_7939 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isPreorder_170 v0
  = case coe v0 of
      C_IsPartialOrder'46'constructor_9297 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_antisym_172 v0
  = case coe v0 of
      C_IsPartialOrder'46'constructor_9297 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isPartialOrder_216 v0
  = case coe v0 of
      C_IsDecPartialOrder'46'constructor_10957 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d__'8799'__218 v0
  = case coe v0 of
      C_IsDecPartialOrder'46'constructor_10957 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Structures.IsDecPartialOrder._≤?_
d__'8804''63'__220 ::
  T_IsDecPartialOrder_206 ->
...
d__'8804''63'__220 v0
  = case coe v0 of
      C_IsDecPartialOrder'46'constructor_10957 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isEquivalence_278 v0
  = case coe v0 of
      C_IsStrictPartialOrder'46'constructor_13145 v1 v3 v4 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_trans_282 v0
  = case coe v0 of
      C_IsStrictPartialOrder'46'constructor_13145 v1 v3 v4 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_'60''45'resp'45''8776'_284 v0
  = case coe v0 of
      C_IsStrictPartialOrder'46'constructor_13145 v1 v3 v4 -> coe v4
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isStrictPartialOrder_324 v0
  = case coe v0 of
      C_IsDecStrictPartialOrder'46'constructor_17873 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d__'8799'__326 v0
  = case coe v0 of
      C_IsDecStrictPartialOrder'46'constructor_17873 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Structures.IsDecStrictPartialOrder._<?_
d__'60''63'__328 ::
  T_IsDecStrictPartialOrder_314 ->
...
d__'60''63'__328 v0
  = case coe v0 of
      C_IsDecStrictPartialOrder'46'constructor_17873 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isPartialOrder_392 v0
  = case coe v0 of
      C_IsTotalOrder'46'constructor_19815 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_total_394 v0
  = case coe v0 of
      C_IsTotalOrder'46'constructor_19815 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isTotalOrder_444 v0
  = case coe v0 of
      C_IsDecTotalOrder'46'constructor_21785 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d__'8799'__446 v0
  = case coe v0 of
      C_IsDecTotalOrder'46'constructor_21785 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Structures.IsDecTotalOrder._≤?_
d__'8804''63'__448 ::
  T_IsDecTotalOrder_434 ->
...
d__'8804''63'__448 v0
  = case coe v0 of
      C_IsDecTotalOrder'46'constructor_21785 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_isEquivalence_512 v0
  = case coe v0 of
      C_IsStrictTotalOrder'46'constructor_23999 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_trans_514 v0
  = case coe v0 of
      C_IsStrictTotalOrder'46'constructor_23999 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_compare_516 v0
  = case coe v0 of
      C_IsStrictTotalOrder'46'constructor_23999 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
