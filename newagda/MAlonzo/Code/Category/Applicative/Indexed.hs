...
data T_RawIApplicative_38
  = C_RawIApplicative'46'constructor_803 (() ->
...
d_pure_58 v0
  = case coe v0 of
      C_RawIApplicative'46'constructor_803 v1 v2 -> coe v1
...
d__'8859'__66 v0
  = case coe v0 of
      C_RawIApplicative'46'constructor_803 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_RawIApplicativeZero_156
  = C_RawIApplicativeZero'46'constructor_10861 T_RawIApplicative_38
                                               (() -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_applicative_170 v0
  = case coe v0 of
      C_RawIApplicativeZero'46'constructor_10861 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Category.Applicative.Indexed.RawIApplicativeZero.∅
d_'8709'_176 ::
...
d_'8709'_176 v0
  = case coe v0 of
      C_RawIApplicativeZero'46'constructor_10861 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
data T_RawIAlternative_210
  = C_RawIAlternative'46'constructor_12437 T_RawIApplicativeZero_156
                                           (() ->
                                            AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
...
d_applicativeZero_224 v0
  = case coe v0 of
      C_RawIAlternative'46'constructor_12437 v1 v2 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
...
d__'8739'__230 v0
  = case coe v0 of
      C_RawIAlternative'46'constructor_12437 v1 v2 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
newtype T_Morphism_274
  = C_Morphism'46'constructor_18487 (() ->
...
d_op_410 v0
  = case coe v0 of
      C_Morphism'46'constructor_18487 v1 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
